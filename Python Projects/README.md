...
This directory contains a collection of Python-based data science projects. These repositories demonstrate my ability to build end-to-end data pipelines, train machine learning models, and extract actionable insights using industry-standard libraries.

---

## 🛠️ Core Libraries & Technologies
*   **Data Manipulation & Cleaning:** `pandas`, `NumPy`
*   **Machine Learning & Predictive Modeling:** `scikit-learn`, `TensorFlow` / `Keras` (RNNs, Logistic Regression)
*   **Data Visualization:** `matplotlib`, `seaborn`
*   **Specialized Analysis:** Natural Language Processing (NLP), Social Network Analysis (SNA)
